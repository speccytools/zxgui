...
enum gui_tiles {
    ...
    GUI_ICON_N,
    GUI_ICON_B,
    GUI_ICON_TILE_BOX_LEFT_TOP,
    GUI_ICON_TILE_BOX_TOP_RIGHT,
    GUI_ICON_TILE_BOX_LEFT_BOTTOM,
    GUI_ICON_TILE_BOX_BOTTOM_RIGHT,
    GUI_ICON_TILE_BOX_BOTTOM,
    GUI_ICON_TILE_BOX_TOP,
    GUI_ICON_TILE_BOX_LEFT,
    GUI_ICON_TILE_BOX_RIGHT,
    GUI_ICON_REFRESH_1,
    GUI_ICON_REFRESH_2,
    GUI_ICON_MESSAGE,
    GUI_ICON_WRITE,
    GUI_ICON_REFRESH_BIG_A_1,
    GUI_ICON_REFRESH_BIG_A_2,
    GUI_ICON_REFRESH_BIG_A_3,
    GUI_ICON_REFRESH_BIG_A_4,
    GUI_ICON_REFRESH_BIG_B_1,
    GUI_ICON_REFRESH_BIG_B_2,
    GUI_ICON_REFRESH_BIG_B_3,
    GUI_ICON_REFRESH_BIG_B_4,
    GUI_ICON_STRIPE_H
};
